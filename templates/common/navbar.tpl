...
<div id="navbar">
	<ul class="menu">
		...
		{/foreach}
		<li>
		  <a class="blockTitle" href="javascript:openHelp('{if $helpTopicId}{get_help_id|escape key="$helpTopicId" url="true"}{else}{url 
page="help"}{/if}')"$f}')">{translate key="navigation.journalHelp"}</a></li>
	</ul>
</div>
